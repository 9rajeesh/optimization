...
public class Validate3P  {
	...
	public static void main(String[] args) {
		...
		PState state = new PState(s);
		
		Double a1 =  state.evaluate(1,2,4,6,8,10,11,13,14,16,17,19);
		Double b1 =  state.evaluate(1,2,3,6,10,18,19);
		Double c1 =  state.evaluate(1,3,5,8,11,9,19,12,14,15);
		Double d1 =  state.evaluate(1,5,6,9,10,11,13,14,18);
		Double e1 =  state.evaluate(1,1,2,3,9,12,15,17,13);
		Double f1 =  state.evaluate(1,6,7,8,10,11,12,17,9,13);
		Double g1 =  state.evaluate(6,1,2,8,10,11,12,16,17,18,19);
		Double h1 =  state.evaluate(7,1,4,5,9,10,11,12,15,16,17);
		Double i1 =  state.evaluate(0,1,3,5,6,7,9,10,12,13,15,18);
		Double j1 =  state.evaluate(9,1,2,8,7,9,11,12);
		
		Double k1 =  state.evaluate(1,11,2,8,9,12,9,8,17,18);
		Double l1 =  state.evaluate(1,9,4,1,2,9,15,16,7,8,9);
		Double m1 =  state.evaluate(1,6,8,10,13,15,16,17);
		Double n1 =  state.evaluate(1,5,8,9,10,11,15,4,12,17,18,19);
		
		Double o1 =  state.evaluate(1,3,8,9,10,11,12);
		Double p1 =  state.evaluate(1,2,3,1,12,13,19);
		Double q1 =  state.evaluate(1,6,8,11,3,14,15);
		
		Double r1 =  state.evaluate(1,1,3,8,9,10,11,12,14,18,19);
		Double s1 =  state.evaluate(1,2,3,1,12,13,15,16,17,19);
		Double t1 =  state.evaluate(1,6,8,11,3,14,15,18);
		...
		System.out.println("prevSum0 is:"+prevSum0);
		System.out.println("prevSum12 is:"+prevSum12);
