...
public class Validate5P  {
	...
	public static void main(String[] args) {
		...
		Double a1 =  state.evaluate(1,2,4,5,8,9,11,15);
		Double b1 =  state.evaluate(1,2,3,7,10,11,12,13);
		Double c1 =  state.evaluate(1,2,4,5,8,10,14,15);
		Double d1 =  state.evaluate(2,3,4,6,10,12,14,15);
		Double e1 =  state.evaluate(3,4,5,7,10,11,14,15);
		Double f1 =  state.evaluate(1,2,5,7,10,12,13,15);
		Double g1 =  state.evaluate(1,4,5,8,10,11,12,14);
		Double h1 =  state.evaluate(4,8,9,10,11,13,14,15);
	
		
		Double i1 =  state.evaluate(1,2,4,5,6,7,8,9);
		Double j1 =  state.evaluate(1,2,3,7,9,11,12,15);
		Double k1 =  state.evaluate(1,4,5,8,10,12,14,15);
		Double l1 =  state.evaluate(2,5,6,7,8,9,10,11);
		Double m1 =  state.evaluate(3,4,5,7,8,13,14,15);
		Double n1 =  state.evaluate(1,2,3,5,9,10,11,12);
		Double o1 =  state.evaluate(4,5,6,7,8,9,10,11);
		Double p1 =  state.evaluate(3,5,6,7,10,11,12,15);
		
		Double sum = a1+b1+c1+d1+e1+f1+g1+h1 +i1+j1+k1+l1+m1+n1+o1+p1;
