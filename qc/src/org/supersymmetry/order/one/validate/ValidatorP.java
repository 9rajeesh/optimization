...
public class ValidatorP {
	...
	static double prev0 = 0.0;
	static double prev1 = 0.0;
	
	static double prev0sum = 0.0;
	static double prev1sum = 0.0;
	...
	public static void main(String[] args) {
		...
		//Long startIndex = 8192L*2 ;
		//Long endIndex =   8192L*4 ;
		//int count = 1;
		...
		Double a1 =  state.evaluate(0,2,4,6,8,10,11,13);
		Double b1 =  state.evaluate(0,1,2,3,6,10);
		Double c1 =  state.evaluate(1,2,3,5,8,11,9);
		Double d1 =  state.evaluate(4,5,6,9,10,11,13);
		Double e1 =  state.evaluate(0,1,2,3,9,12);
		...
		//zeroList.add(sum);
		//oddEven0(sum+sum);
		prev0sum = prev0sum + Math.pow((sum*sum-prev0*prev0),2);
		prev0 = sum;
		...
		///oddEven1(sum+sum);
		//System.out.println("Bell is:"+bell(sum));
		prev1sum = prev1sum + Math.pow((sum*sum-prev1*prev1),2);
		prev1 = sum;
		}
		...
		System.out.println("prevsum0 is:"+prev0sum);
		System.out.println("prevsum1 is:"+prev1sum);
		System.out.println("sum2_1 is:"+sum2_1);
