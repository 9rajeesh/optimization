...
public class Validate8  {
	...
	public static void main(String[] args) {
		...
		Double a1 =  state.evaluate(1,2,4,6,8, 10,11,13,15,19, 5);
		Double b1 =  state.evaluate(1,2,3,4,6, 10,12,15,18,19, 8);
		Double c1 =  state.evaluate(1,2,3,5,8, 11,12,14,15,16, 4);
		Double d1 =  state.evaluate(4,5,6,9,10,11,12,14,18,19, 13);
		
		Double e1 =  state.evaluate(1,2,3,5,6, 7,9,10,13,14, 4);
		Double f1 =  state.evaluate(4,6,7,8,9, 10,11,12,14,15, 13);
		Double g1 =  state.evaluate(1,2,3,4,6, 8,9,10,11,14, 12);
		Double h1 =  state.evaluate(1,2,4,5,9, 10,11,12,15,17, 19);
		
		Double i1 =  state.evaluate(1,3,5,6,7,  8,9,10,11,12, 13);
		Double j1 =  state.evaluate(1,2,3,8,7,  11,10,12,14,18, 9);
		Double k1 =  state.evaluate(1,2,5,9,10, 11,12,13,14,15, 3);
		Double l1 =  state.evaluate(5,6,7,9,10, 12,13,15,18,19, 11);
		
		Double m1 =  state.evaluate(3,6,8,10,13, 15,16,17,18,19, 5);
		Double n1 =  state.evaluate(1,5,8,9,10,  11,13,15,18,19, 12);
		Double o1 =  state.evaluate(1,4,5,7,8, 10,11,12,15,19, 9);
		Double p1 =  state.evaluate(2,4,5,9,10, 11,13,14,18,19, 12);
		
		Double q1 =  state.evaluate(4,5,7,8,9, 10,13,15,18,19, 11);
		Double r1 =  state.evaluate(3,6,9,10,11, 12,13,14,15,16, 17);
		Double s1 =  state.evaluate(1,2,3,5,9, 10,11,12,13,14, 4);
		Double t1 =  state.evaluate(1,2,4,5,6, 9,10,11,12,14, 13);
